...
//Implement all the methods mentioned to build a ListADT
    ...
    */
     ...
     * @param capacityc new capacity
     */
    public List(final int capacityc) {
        size = 0;
        this.capacity = capacityc;
        list = new int[capacityc];
    }
     ...
     * You know enough of OOP to answer these questions :-)
     *
     */
    ...
    */
    public int[] resize() {
       return java.util.Arrays.copyOf(list, 2 * this.capacity);
    }
     ...
     *
     * @param item number
     * @return index of the above number
     */
