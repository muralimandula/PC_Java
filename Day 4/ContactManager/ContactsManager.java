/**
 * This class maintains contacts of your friends/relations/wellwishers etc.,
 *
...
final class ContactsManager {
    ...
    /**
     * This method search for the contact based on the name of your friend and
     *  gives the first occurance of the contact in your friends list.
     * @param searchName the name of the contact to be searched in list.
     ...
     * @param email the email of the contact to be searched in list.
     * @return the contact of the friend, null otherwise.
     */
    ...
    /**
     * This method deletes the contact based on the name and returns
